function layout(element) {
	...
	flexLines.forEach(items => {
		...
		for (let i = 0; i < items.length; i++) {
			...
			let align = itemStyle.alignSeflt || style.alignItems;
			...
			if (align === 'stretch') {
				itemStyle[crossStart] = crossBase;
				itemStyle[crossEnd] = itemStyle[crossStart] + crossSign * ((itemStyle[crossSize] !== null && itemStyle[crossSize] !==
					0) ? itemStyle[crossSize] : lineCrossSize);
